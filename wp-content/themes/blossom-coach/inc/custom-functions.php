        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'blossom-coach' ), $name ) ; ?></p>
...
if( ! function_exists( 'blossom_coach_admin_notice_display' ) ) :
/**
 * ignore notice
 */
function blossom_coach_admin_notice_display() {

    update_option( 'blossom-coach-update-notice', false );

}
endif;
add_action( 'after_switch_theme', 'blossom_coach_admin_notice_display' );